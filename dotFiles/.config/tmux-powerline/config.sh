...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="my-theme" #"default"
...
# date.sh {
	...
	export TMUX_POWERLINE_SEG_DATE_FORMAT="%H:%M:%S %a/%b/%d" # "%F"
# }
...
# tmux_mem_cpu_load.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_MEM_CPU_LOAD_ARGS="-l 235 -r 33 -g 0 -t 0 -a 0" # -q -l 235 -r 33
# }
...
# weather.sh {
	...
	export TMUX_POWERLINE_SEG_WEATHER_LAT="34.8081"
	export TMUX_POWERLINE_SEG_WEATHER_LON="113.5358"
# }
